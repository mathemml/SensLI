...
path0 = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), f'results_data_spirals/Exp{k}_0.json')
...
for i in range(no_of_initializations):
    ...
    if T2:
        ...
        if plot:
            ...
            plt.show()
        # save losses2
        write_losses(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), f'results_data_spirals/Exp{k}_2.json'), mb_losses2, max_length, end_list, test_errors2,
